 ...
 * @version 1524582586609
 */
const patternManifest_1524582586609 = {
  "commonInfo": {
    "modulifier": [
      "responsive",
      "images",
    ...
    "theme": {
      ...
      "fonts": {
        ...
        "secondary": {
          ...
          "raw": "\"Montserrat\", arial, sans-serif",
          "weights": {
            "normal": {
              "weight": "normal",
              "hasNormal": true,
    ...
    "readme": {
      ...
      "bodyBasic": "Designer Shells and vivarium accessories for the discerning crab."
    },
    "icons": [
      "facebook-icon-white",
      "facebook-icon",
...
patternBotIncludes(patternManifest_1524582586609);
}());